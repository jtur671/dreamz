...
- Support URL: https://dreamz-journal.com/support

---

## Notes

- Snapshot this file before any ASO change, then re-pull after to confirm upload.
- **Search Terms report** (ASC Analytics → Sources → Search Terms) is pulled separately via the analytics reports flow — see `pull:terms` command (TBD).
- Screenshots are NOT pulled by this snapshot — verify in the ASC web dashboard or add to `tools/asc-baseline/src/screenshots.ts` in a future pass.
